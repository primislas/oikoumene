package com.lomicron.vicky.model.map

import com.lomicron.oikoumene.model.map.{ElevatedLake, MercatorMap, River, Route}
...
import com.lomicron.vicky.repository.api.{ProvinceRepository, RepositoryFactory}
