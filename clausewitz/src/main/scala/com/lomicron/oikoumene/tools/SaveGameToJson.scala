...
object SaveGameToJson extends LazyLogging {
  ...
  def printHelp(): Unit = {
    val help =
      """help:
        |oikoumene save game parser v1.0
        |Convert .eu4 save file to json for easier navigation.
        |
        |usage: sbt "runMain com.lomicron.oikoumene.tools.SaveGameToJson
        |             [--help|-h]
        |             [--save-game|-save <save_file_path>]
        |             [--output-dir|-od <output_dir>]
        |
        |e.g.
        |sbt -J-Xmx3G -J-Xss3M "runMain com.lomicron.oikoumene.tools.SaveGameToJson -save \"C:/Users/username/Documents/Paradox Interactive/Europa Universalis IV/save games/autosave.eu4\" -od \"C:/Users/username/Documents/Paradox Interactive/Europa Universalis IV/mod/parsed_saves\""
        |
        |""".stripMargin
    logger.info(help)
  }
