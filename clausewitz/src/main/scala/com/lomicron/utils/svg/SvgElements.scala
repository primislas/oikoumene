...
object SvgElements {
  ...
  val style: SvgElement = SvgElement(tag = SvgTags.STYLE)
  ...
  val image: SvgElement = SvgElement(tag = SvgTags.IMAGE)
  val pattern: SvgElement = SvgElement(tag = SvgTags.PATTERN)
  val defs: SvgElement = SvgElement(tag = SvgTags.DEFS)
  val title: SvgElement = SvgElement(tag = SvgTags.TITLE)
